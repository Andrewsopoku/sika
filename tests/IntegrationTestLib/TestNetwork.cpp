...
#ifdef _WIN32
const std::string sikabitDaemon = "sikabitd.exe";
#else
const std::string sikabitDaemon = "sikabitd";
#endif
...
TestNodeConfiguration TestNetworkBuilder::buildNodeConfiguration(size_t index) {
  ...
  cfg.daemonPath = sikabitDaemon; // default
  cfg.testnet = testnet;
  cfg.logFile = "test_sikabitd" + std::to_string(index) + ".log";
